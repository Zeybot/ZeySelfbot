...
dz = LINE("EABYo1xku1OamvsdHvVc.Pr5KmhJvaKdY2L9qNIm2Na.+4HnrUcSY6yX8k7DRDNy14JzMZNgkfQHVm/RlKrI3QA=")
...
#==================[ REBOOT ]===================
                ...
                start = time.time()
                dz.sendMessage(msg.to, "menghitung beha.. waiting..")
...
#=================================================                
                ...
                for i in gid:
                  ...
                  if h == ng:
                    ...
                    dz.sendMessage(i,"ᴀᴜᴛᴏ sɪᴅᴇʀ ʙʏ: Ze")
                    pro["prosider"][i] = True
                    with open('pro.json', 'w') as fp:
                        json.dump(pro, fp, sort_keys=True, indent=4)
                    try:
...
#=============================================
                ...
                for a in range(k+1):
                    ...
                    with open('pro.json', 'w') as fp:
                        json.dump(pro, fp, sort_keys=True, indent=4)
                    dz.sendMessage(msg.to, "Cctv ᴍᴏᴅᴇ ᴏɴ ʙᴏs")
                    try:
                    ...
                    with open('pro.json', 'w') as fp:
                        json.dump(pro, fp, sort_keys=True, indent=4)
                    dz.sendMessage(msg.to, "Cctv ᴍᴏᴅᴇ ᴏғғ ʙᴏs")
                    try:
                        del ciduk['ceadPoint'][msg.to]
                        del ciduk['ceadMember'][msg.to]
                    except:
